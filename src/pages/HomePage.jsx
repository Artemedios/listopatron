  ...
  <footer role="contentinfo" aria-label="Pie de página" style={{"background": "#1D1E2C", "padding": "60px 20px 40px", "textAlign": "center"}}>
    <div style={{"maxWidth": "800px", "margin": "0 auto", "display": "flex", "flexDirection": "column", "alignItems": "center", "gap": "16px"}}>
      ...
      <div style={{"display": "flex", "gap": "12px", "alignItems": "center", "flexWrap": "wrap", "justifyContent": "center", "background": "rgba(255,255,255,0.03)", "padding": "12px 20px", "borderRadius": "12px", "border": "1px solid rgba(255,255,255,0.08)", "marginTop": "8px"}}>
        ...
        <div style={{"border": "1px solid rgba(255,255,255,0.2)", "borderRadius": "6px", "padding": "6px 12px", "color": "#fff", "fontSize": "12px", "fontWeight": "600"}}>Verified by VISA</div>
        <div style={{"border": "1px solid rgba(255,255,255,0.2)", "borderRadius": "6px", "padding": "6px 12px", "color": "#fff", "fontSize": "12px", "fontWeight": "600"}}>Mastercard ID Check</div>
      </div>
