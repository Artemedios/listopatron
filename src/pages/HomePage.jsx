...
<footer role="contentinfo" aria-label="Pie de página">
  <div className="footer-grid">
    ...
    <div>
      ...
      <ul className="footer-links">
        <li><a href="/cdn-cgi/l/email-protection#3b7752484f544b5a4f495455155a4b4b7b5c565a525715585456">📧 <span className="__cf_email__" data-cfemail="074b6e7473687766737568692966777747606a666e6b2964686a">[email&#160;protected]</span></a></li>
        <li><a href="tel:+18099090455">📞 +1 (809) 909-0455</a></li>
        <li><a href="https://wa.me/18099090455" target="_blank">💬 WhatsApp</a></li>
      </ul>
    </div>
  </div>
  <div className="footer-bottom">
    <span className="footer-copy">© 2026 Listo · República Dominicana · Todos los derechos reservados</span>
